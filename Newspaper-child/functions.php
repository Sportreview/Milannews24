...
function register_button($buttons) {
  array_push($buttons, "video_mil24");
  return $buttons;
}

function add_plugin($plugin_array) {
  $plugin_array['video_mil24'] = get_stylesheet_directory_uri().'/js/customcodes.js';
  return $plugin_array;
}
...
//Funzione di recupero diretto delle locandine recuperate da VIMEO
    ...
    $request = "//vimeo.com/api/oembed.json?url=http%3A%2F%2Fvimeo.com%2F".$vid."";
    $ch = curl_init();
...
wp_enqueue_script( 'video_mil24_js', get_stylesheet_directory_uri().'/js/video_mil24.js' );
function video_mil24($atts, $content = null) {
...
add_shortcode("video_mil24", "video_mil24");
// END Video JS Engine | ARTICOLO


// Sliding Player
function videoslide_mil24($atts, $content = null) {
  ...
  ?>
    ...
    var prerollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/165059490/Milannews24.com/Preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=milannews24.com&description_url=milannews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var postrollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/165059490/Milannews24.com/Preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=milannews24.com&description_url=milannews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var prerollTagSidebarRepeat = prerollTagSidebar;
    var dfpSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/165059490/Milannews24.com/Preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=milannews24.com&description_url=milannews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
  ...
  var settings = {
    logo: '<?php echo site_url(); ?>/wp-content/themes/Newspaper-child/images/logo-mil24-video.png',
    logoLoc: '<?php echo site_url(); ?>/',
    licenseKey: 'dG54dHd4aXh6aEAxNTA5NDU3',
    pathToRmpFiles: '//cdn.sportreview.it/radiantmp/latest/',
    gaTrackingId: 'UA-11488352-13',
  ...
  add_shortcode("videoslide_mil24", "videoslide_mil24");
  //END Sliding Player


// Video Playlist Home
function video_playlist_mil24($atts, $content = null) {
...
add_shortcode("video_playlist_mil24", "video_playlist_mil24");
// Video Playlist Home END
...
function adv_libs() { ?>
  ...
  if (!isMobileNewtek) {
    ...
    googletag.defineSlot('/21624773413/Milannews24.com/Mpu_Middle', [300, 250], 'div-gpt-ad-Mpu_Middle').addService(googletag.pubads());
    ...
    googletag.defineSlot('/67970281/display_thirdparty_it/milannews24_responsive/ros/top_banner', [[1056, 250], [728, 90], [980, 250], [970, 250]], 'div-gpt-ad-1521731706916-2').setTargeting('Display_Ad_Position', ['ATF']).addService(googletag.pubads());
    ...
    googletag.defineSlot('/67970281/display_thirdparty_it/milannews24_responsive/ros/top_mpu', [[300, 600], [300, 250]], 'div-gpt-ad-1521731706916-3').setTargeting('Display_Ad_Position', ['ATF']).addService(googletag.pubads());
    ...
    googletag.defineSlot('/67970281/display_thirdparty_it/milannews24_responsive/homepage/top_banner', [320, 50], 'div-gpt-ad-1521731619422-2').setTargeting('Display_Ad_Position', ['ATF']).addService(googletag.pubads());
    ...
    googletag.defineSlot('/67970281/display_thirdparty_it/milannews24_responsive/homepage/top_mpu', [300, 250], 'div-gpt-ad-1521731619422-3').setTargeting('Display_Ad_Position', ['ATF']).addService(googletag.pubads()); 
    googletag.pubads().enableSingleRequest();
      googletag.pubads().collapseEmptyDivs();
      googletag.enableServices();
 });
...
jQuery("#div-gpt-ad-1521731619422-1").hide();
}
</script>
</div>
  <?php } else { ?>
    <!-- /67970281/display_thirdparty_it/milanonews24_responsive/ros/skin -->
    <div id='div-gpt-ad-1521731706916-1' style='height:1px; width:1px;'>
      <script>
        if (!isMobileNewtek) {
          ...
          jQuery("#div-gpt-ad-1521731706916-1").hide();
        }
      </script>
    </div>
  <?php }
...
<script>
        if (isMobileNewtek) {
          ...
          jQuery("#div-gpt-ad-1521731619422-0").hide();
        }
      </script>
    </div>
  <?php } else { ?>
    ...
    <div id='div-gpt-ad-1521731706916-0'>
      <script>
        if (isMobileNewtek) {
          ...
          jQuery("#div-gpt-ad-1521731706916-0").hide();
        }
      </script>
    </div>
  <?php }
...
function adv_top_mobile() { ?>
 <!-- /67970281/display_thirdparty_it/milannews24_responsive/homepage/top_mpu -->
  <div id='div-gpt-ad-1521731619422-3'>
  <script>
    if (isMobileNewtek) {
      googletag.cmd.push(function() { googletag.display('div-gpt-ad-1521731619422-3'); });
    } else {
      jQuery("#div-gpt-ad-1521731619422-3").hide();
    }
  </script>
  </div>
<?php }//adv_top_mobile
...
function adv_mpu_middle() { ?>
  <!-- /21624773413/Milannews24.com/Mpu_Middle -->
...
function adv_bottom_mobile() {
  if (is_front_page()) { ?>
   <!-- /67970281/display_thirdparty_it/milannews24_responsive/homepage/top_banner -->
<div id='div-gpt-ad-1521731619422-2' style='height:50px; width:320px;'>
<script>
        if (isMobileNewtek) {
